...
export function DashboardSidebar({ pastShiftsStatus = [], selectedDate, onSelectDate, activeView = "Dashboard", onViewChange, onLogout, appRole, ...props }: DashboardSidebarProps) {
        ...
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" className="cursor-default hover:bg-transparent">
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-bold text-sm">Pirates Bay</span>
                <span className="truncate text-xs text-muted-foreground">admin@piratesbay.it</span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
